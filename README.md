...
- DataCat, an in-app APM dashboard, tracks latency percentiles per route, individual request latency, error rates, and cache hit rates using Rails instrumentation
